...
final class TpayTransactionChannelResolverTest extends TestCase
{
    ...
    public function test_it_resolves_an_empty_array_when_tpay_exception_is_thrown(): void
    {
        ...
        ;
        $this->logger
            ->critical('Unable to get banks list. TpayException thrown.', ['exceptionMessage' => 'Booo! I am a TpayException! in file /home/kevin/Projects/CommerceWeavers/SyliusTpayPlugin/tests/Unit/Tpay/Resolver/TpayTransactionChannelResolverTest.php line: 69'])
            ->shouldBeCalled()
        ;
