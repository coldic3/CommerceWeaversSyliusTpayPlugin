...
final class Version20241018122254 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE sylius_tpay_blik_alias (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, value VARCHAR(255) NOT NULL, expiration_date DATETIME NOT NULL, registered TINYINT(1) DEFAULT false NOT NULL, UNIQUE INDEX UNIQ_E929ACD69395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
